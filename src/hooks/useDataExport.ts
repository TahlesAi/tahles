...
export const useDataExport = () => {
  ...
  const createExcelData = () => {
    const data = {
      ...
      // גיליון 7: מיפוי חטיבות (חדש)
      divisionMapping: [
        { 'חטיבה': 'הפקות', 'קטגוריות נוכחיות': 'לוקיישנים, מזון ומשקאות, שירותי הפקה', 'סטטוס': 'דורש מיפוי' },
        { 'חטיבה': 'העשרה', 'קטגוריות נוכחיות': 'הרצאות והכשרות', 'סטטוס': 'תואם חלקית' },
        { 'חטיבה': 'מתנות', 'קטגוריות נוכחיות': 'מתנות וכרטיסים', 'סטטוס': 'תואם חלקית' },
        { 'חטיבה': 'כרטיסים', 'קטגוריות נוכחיות': 'מתנות וכרטיסים', 'סטטוס': 'דורש פיצול' },
        { 'חטיבה': 'טיולים', 'קטגוריות נוכחיות': 'טיולים ואטרקציות', 'סטטוס': 'תואם' }
      ]
    };
